...
extern String_t* _stringLiteral1148467899;
extern String_t* _stringLiteral3341457046;
extern const uint32_t WWW_LoadImageIntoTexture_m3209745837_MetadataUsageId;
...
public:
	...
	Dictionary_2_t1632706988 * ____responseHeaders_2;
...
public:
	...
	inline static int32_t get_offset_of__responseHeaders_2() { return static_cast<int32_t>(offsetof(WWW_t3688466362, ____responseHeaders_2)); }
	inline Dictionary_2_t1632706988 * get__responseHeaders_2() const { return ____responseHeaders_2; }
	inline Dictionary_2_t1632706988 ** get_address_of__responseHeaders_2() { return &____responseHeaders_2; }
	inline void set__responseHeaders_2(Dictionary_2_t1632706988 * value)
	{
		____responseHeaders_2 = value;
		Il2CppCodeGenWriteBarrier((&____responseHeaders_2), value);
	}
};
...
IL_0071:
		{
			KeyValuePair_2_t4030379155  L_14 = Enumerator_get_Current_m4125185638((&V_3), /*hidden argument*/Enumerator_get_Current_m4125185638_RuntimeMethod_var);
			V_2 = L_14;
			UnityWebRequest_t463507806 * L_15 = __this->get__uwr_0();
			String_t* L_16 = KeyValuePair_2_get_Key_m3938572407((&V_2), /*hidden argument*/KeyValuePair_2_get_Key_m3938572407_RuntimeMethod_var);
			String_t* L_17 = KeyValuePair_2_get_Value_m2642806556((&V_2), /*hidden argument*/KeyValuePair_2_get_Value_m2642806556_RuntimeMethod_var);
			NullCheck(L_15);
...
IL_0092:
		{
			bool L_18 = Enumerator_MoveNext_m897800495((&V_3), /*hidden argument*/Enumerator_MoveNext_m897800495_RuntimeMethod_var);
			if (L_18)
			{
				goto IL_0071;
			}
...
IL_0017:
	{
		Dictionary_2_t1632706988 * L_2 = __this->get__responseHeaders_2();
		if (L_2)
		{
			goto IL_008b;
		}
	}
	{
		...
		__this->set__responseHeaders_2(L_4);
		Dictionary_2_t1632706988 * L_5 = __this->get__responseHeaders_2();
		if (!L_5)
		{
			goto IL_007f;
		}
	...
	{
		Dictionary_2_t1632706988 * L_6 = __this->get__responseHeaders_2();
...
IL_007f:
	{
		...
		__this->set__responseHeaders_2(L_15);
	}
...
IL_008b:
	{
		Dictionary_2_t1632706988 * L_16 = __this->get__responseHeaders_2();
		V_0 = L_16;
		goto IL_0097;
	}
...
extern "C"  void WWW_LoadImageIntoTexture_m3209745837 (WWW_t3688466362 * __this, Texture2D_t3840446185 * ___texture0, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL_0011:
	...
	}
	{
		...
		Debug_LogError_m2850623458(NULL /*static, unused*/, _stringLiteral1148467899, /*hidden argument*/NULL);
		goto IL_0061;
	}
...
IL_0031:
	{
		...
		DownloadHandler_t2937767557 * L_4 = UnityWebRequest_get_downloadHandler_m534911913(L_3, /*hidden argument*/NULL);
		V_0 = L_4;
		DownloadHandler_t2937767557 * L_5 = V_0;
		if (L_5)
		{
			goto IL_0053;
		}
	...
	{
		IL2CPP_RUNTIME_CLASS_INIT(Debug_t3317548046_il2cpp_TypeInfo_var);
		Debug_LogError_m2850623458(NULL /*static, unused*/, _stringLiteral3341457046, /*hidden argument*/NULL);
		goto IL_0061;
	}
...
IL_0053:
	{
		...
		DownloadHandler_t2937767557 * L_7 = V_0;
		NullCheck(L_7);
		ByteU5BU5D_t4116647657* L_8 = DownloadHandler_get_data_m1669096410(L_7, /*hidden argument*/NULL);
		ImageConversion_LoadImage_m601733642(NULL /*static, unused*/, L_6, L_8, (bool)0, /*hidden argument*/NULL);
	}
